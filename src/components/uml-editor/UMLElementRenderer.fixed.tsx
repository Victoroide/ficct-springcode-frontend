...
export const UMLElementRenderer: React.FC<UMLElementRendererProps> = ({
  ...
  // Helper function for conditional styles (light mode only since we removed ThemeContext)
  ...
  const handleContextMenu = (e: React.MouseEvent) => {
    ...
    const menuItems = [
      ...
      { divider: true },
      {
        ...
        action: () => {
          if (onUpdate) {
            onUpdate(element.id, { _delete: true });
          }
        },
        danger: true
      }
      ...
      <div className="item-content">
        ...
        {(attr.isStatic || attr.isFinal) && (
          <div className="flex space-x-1">
            ...
            {attr.isFinal && (
              <span className="text-xs px-1 rounded bg-purple-100 text-purple-800">
                final
              </span>
            )}
          </div>
        ...
        {isEditingName ? (
          <div className="flex items-center justify-center space-x-1 mt-1">
            <input
              ...
              className="text-center px-2 py-1 text-sm border rounded font-bold bg-transparent border-gray-400 text-gray-900"
              style={{
                backgroundColor: colors.header,
                color: colors.text,
                minWidth: '120px',
            ...
            <button
              ...
              className="px-1 py-1 text-xs rounded bg-green-500 text-white hover:bg-green-600"
              disabled={isLoading}
              title="Save"
            >
              ✓
            ...
            <button
              ...
              className="px-1 py-1 text-xs rounded bg-gray-500 text-white hover:bg-gray-600"
              disabled={isLoading}
              title="Cancel"
            >
              ✕
